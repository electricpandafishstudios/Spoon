...
--Spoon things
ActorStats:defineStat("Adenine",	"A", 10, 1, 100, "Heats up the action")
ActorStats:defineStat("Thymine",	"T", 10, 1, 100, "Adds to sturdyness")
ActorStats:defineStat("Guanine",	"G", 10, 1, 100, "???")
ActorStats:defineStat("Cytosine",	"C", 10, 1, 100, "Bulk up")
